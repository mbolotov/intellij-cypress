...
## Install
Plugin can be installed from the Jetbrains Marketplace. Open '*Settings/Preferences* -> *Plugins*' menu item and type '**Cypress**' in the search bar. See [here](https://www.jetbrains.com/help/idea/managing-plugins.html) for details. Plase note that base and Pro versions are not expected to run together and you should disable or uninstall one of them to use the other. 
## Usage
